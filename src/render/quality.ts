...
export const TIERS: QualityTier[] = [
  ...
  { name: 'medium', dustParticles: 25000, galaxyParticles: 60000, bloom: true, lensing: false, dpr: 1.5 },
  { name: 'high', dustParticles: 60000, galaxyParticles: 140000, bloom: true, lensing: true, dpr: 2 },
];
...
export function activeTier(s: GameState): QualityTier {
  if (s.settings.quality === 0) return detectTier();
